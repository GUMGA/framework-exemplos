package br.com.customFields.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.customFields.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.customFields");
