package br.com.tenancy.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.tenancy.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.tenancy");
