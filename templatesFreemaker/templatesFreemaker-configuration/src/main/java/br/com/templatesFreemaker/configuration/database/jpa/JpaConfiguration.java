package br.com.templatesFreemaker.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.templatesFreemaker.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.templatesFreemaker");
