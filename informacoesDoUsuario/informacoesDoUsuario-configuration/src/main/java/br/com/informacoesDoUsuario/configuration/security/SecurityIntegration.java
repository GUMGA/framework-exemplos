package br.com.informacoesDoUsuario.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.informacoesDoUsuario.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*informacoesDoUsuario-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-informacoesDoUsuario", BASE + ".*", ".*")
    );
