package br.com.fileUpload.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.fileUpload.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.fileUpload");
