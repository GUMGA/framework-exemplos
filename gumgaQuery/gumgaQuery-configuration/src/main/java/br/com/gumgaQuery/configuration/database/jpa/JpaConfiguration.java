package br.com.gumgaQuery.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.gumgaQuery.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.gumgaQuery");
    ...
    private Properties commonProperties() {
        ...
        properties.setProperty("hibernate.show_sql", getProperties().getProperty("hibernate.show_sql", "true"));
