package br.com.registrosCompartilhados.configuration.application;
...
public class ApplicationConstants implements GumgaValues {
    ...
    public String getCustomPropertiesFileName() {
        return "registrosCompartilhados.properties";
    }

    @Override
    public String getGumgaNLPBasePackage() {
        return "br.com.registrosCompartilhados.domain";
    }


    @Override
    public String getSoftwareName() {
        return "br.com.registrosCompartilhados";
    }
}
