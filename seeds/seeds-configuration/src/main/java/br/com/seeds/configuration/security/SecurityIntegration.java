package br.com.seeds.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.seeds.configuration.security.SecurityIntegration.class);
