package br.com.remocaoLogica.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.remocaoLogica.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.remocaoLogica");
