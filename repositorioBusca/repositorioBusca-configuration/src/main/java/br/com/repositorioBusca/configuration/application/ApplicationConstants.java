package br.com.repositorioBusca.configuration.application;
...
public class ApplicationConstants implements GumgaValues {
    ...
    public String getCustomPropertiesFileName() {
        return "repositorioBusca.properties";
    }

    @Override
    public String getGumgaNLPBasePackage() {
        return "br.com.repositorioBusca.domain";
    }


    @Override
    public String getSoftwareName() {
        return "br.com.repositorioBusca";
    }
}
