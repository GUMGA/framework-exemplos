package br.com.gumgaNLP.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.gumgaNLP.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*gumgaNLP-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-gumgaNLP", BASE + ".*", ".*")
    );
