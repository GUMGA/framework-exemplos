package br.com.registrosCompartilhados.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.registrosCompartilhados.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*registrosCompartilhados-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-registrosCompartilhados", BASE + ".*", ".*")
    );
