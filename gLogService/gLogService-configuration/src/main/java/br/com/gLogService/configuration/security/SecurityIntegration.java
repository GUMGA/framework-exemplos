package br.com.gLogService.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.gLogService.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*gLogService-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-gLogService", BASE + ".*", ".*")
    );
