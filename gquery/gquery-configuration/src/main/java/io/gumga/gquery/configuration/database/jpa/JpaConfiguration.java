package io.gumga.gquery.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import io.gumga.gquery.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "io.gumga.gquery");
