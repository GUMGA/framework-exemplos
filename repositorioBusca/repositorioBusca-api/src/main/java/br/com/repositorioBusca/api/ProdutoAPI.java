...
public class ProdutoAPI extends GumgaAPI<Produto, Long> {
    ...
    @RequestMapping("/nomeContem/{param}")
    public List<Produto> getProdutoNomeContem(@PathVariable("param") String param){
        return service.getListProdutoNomeContains(param);
    }



//    @RequestMapping("/nomeContain/{param}"){
//
//    }
