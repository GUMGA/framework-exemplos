package br.com.informacoesDoUsuario.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.informacoesDoUsuario.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.informacoesDoUsuario");
