package br.com.criptografiaJasypt.configuration.application;
...
public class ApplicationConstants implements GumgaValues {
    ...
    public String getCustomPropertiesFileName() {
        return "criptografiaJasypt.properties";
    }

    @Override
    public String getGumgaNLPBasePackage() {
        return "br.com.criptografiaJasypt.domain";
    }


    @Override
    public String getSoftwareName() {
        return "br.com.criptografiaJasypt";
    }
}
