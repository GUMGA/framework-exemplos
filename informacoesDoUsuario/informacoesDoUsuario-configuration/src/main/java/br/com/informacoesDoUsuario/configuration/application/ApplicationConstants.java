package br.com.informacoesDoUsuario.configuration.application;
...
public class ApplicationConstants implements GumgaValues {
    ...
    public String getCustomPropertiesFileName() {
        return "informacoesDoUsuario.properties";
    }

    @Override
    public String getGumgaNLPBasePackage() {
        return "br.com.informacoesDoUsuario.domain";
    }


    @Override
    public String getSoftwareName() {
        return "br.com.informacoesDoUsuario";
    }
}
