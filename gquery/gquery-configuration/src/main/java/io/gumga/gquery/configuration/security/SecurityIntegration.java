package io.gumga.gquery.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(io.gumga.gquery.configuration.security.SecurityIntegration.class);
