package br.com.tenancy.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.tenancy.configuration.security.SecurityIntegration.class);
