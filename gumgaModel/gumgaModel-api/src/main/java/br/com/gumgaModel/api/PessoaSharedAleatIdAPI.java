...
@RestController
@RequestMapping("/api/pessoasharedaleatid")
@Transactional
public class PessoaSharedAleatIdAPI extends GumgaAPI<PessoaSharedAleatId, String> {


    @Autowired
    public PessoaSharedAleatIdAPI(GumgaService<PessoaSharedAleatId, String> service) {
        super(service);
    }
