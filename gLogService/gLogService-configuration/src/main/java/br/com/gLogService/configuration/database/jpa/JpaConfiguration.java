package br.com.gLogService.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.gLogService.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.gLogService");
