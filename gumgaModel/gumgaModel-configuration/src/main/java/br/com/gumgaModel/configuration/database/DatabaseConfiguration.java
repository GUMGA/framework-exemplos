package br.com.gumgaModel.configuration.database;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import io.gumga.core.GumgaValues;
import br.com.gumgaModel.configuration.application.ApplicationConstants;
...
public class DatabaseConfiguration {
    ...
    private HikariConfig commonConfig() {
        GumgaQueryParserProvider.defaultMap = gumgaQueryParseProviderFactory("H2");
        ...
        config.addDataSourceProperty("url", "jdbc:h2:mem:teste;MVCC=true");
