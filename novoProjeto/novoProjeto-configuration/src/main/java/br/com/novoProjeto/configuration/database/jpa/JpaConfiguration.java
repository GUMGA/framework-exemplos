package br.com.novoProjeto.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.novoProjeto.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.novoProjeto");
