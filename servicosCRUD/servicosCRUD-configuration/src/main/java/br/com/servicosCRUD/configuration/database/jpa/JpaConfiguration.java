package br.com.servicosCRUD.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.servicosCRUD.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.servicosCRUD");
