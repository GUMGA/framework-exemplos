package br.com.templatesFreemaker.configuration.application;
...
public class ApplicationConstants implements GumgaValues {
    ...
    public String getCustomPropertiesFileName() {
        return "templatesFreemaker.properties";
    }

    @Override
    public String getGumgaNLPBasePackage() {
        return "br.com.templatesFreemaker.domain";
    }


    @Override
    public String getSoftwareName() {
        return "br.com.templatesFreemaker";
    }
}
