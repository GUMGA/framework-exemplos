...
@RestController
@RequestMapping("/api/pessoaremocaologica")
@Transactional
public class PessoaRemocaoLogicaAPI extends GumgaAPI<PessoaRemocaoLogica, Long> {


    @Autowired
    public PessoaRemocaoLogicaAPI(GumgaService<PessoaRemocaoLogica, Long> service) {
        super(service);
    }
