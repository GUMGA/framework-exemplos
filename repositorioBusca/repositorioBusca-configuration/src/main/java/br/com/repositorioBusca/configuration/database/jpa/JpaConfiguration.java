package br.com.repositorioBusca.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.repositorioBusca.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.repositorioBusca");
