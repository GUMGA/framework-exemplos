package br.com.variavelAmbiente.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.variavelAmbiente.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.variavelAmbiente");
