package io.gumga.buscatextual.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import io.gumga.buscatextual.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "io.gumga.buscatextual");
