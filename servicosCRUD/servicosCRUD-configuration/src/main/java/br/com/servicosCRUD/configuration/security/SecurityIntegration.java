package br.com.servicosCRUD.configuration.security;
...
public class SecurityIntegration {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(br.com.servicosCRUD.configuration.security.SecurityIntegration.class);
     ...
     */
    public static final String BASE = ".*servicosCRUD-api.api";

    /**
     * Operações do Software
     */
    public static final List<OperationExpression> operations = Arrays.asList(
            new OperationExpression("CRUD-servicosCRUD", BASE + ".*", ".*")
    );
