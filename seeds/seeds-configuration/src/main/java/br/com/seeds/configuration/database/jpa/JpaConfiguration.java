package br.com.seeds.configuration.database.jpa;

import io.gumga.core.GumgaValues;
import br.com.seeds.configuration.application.ApplicationConstants;
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga", "br.com.seeds");
